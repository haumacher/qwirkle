...
var $strongName = 'E90203727D5C7AFCD9E5E82AF35C2DFD';
var $gwt = {};
...
function $beiKnopfLosLassen(this$static, left, top_0, steinDarstellung){
  ...
  column = position._x;
  row = position._y;
  if ($zugErlaubt(this$static._spielfeldDarstellung._spielfeld, column, row, stein)) {
    $fügeEin(this$static._spielfeldDarstellung, column, row, stein);
